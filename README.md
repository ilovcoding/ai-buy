...
You can deploy your own version of the 小快 AI 购 to Vercel with one click:
...
You will need to use the environment variables [defined in `.env.example`](.env.example) to run 小快 AI 购. It's recommended you use [Vercel Environment Variables](https://vercel.com/docs/concepts/projects/environment-variables) for this, but a `.env` file is all that is necessary.
